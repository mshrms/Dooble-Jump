...
{
	//доступно дл€ проверок движущихс€ платформ и по€влени€ персонажа с другой стороны экрана
	...
	private void GenerateRandomPlatform()
	{
		...
		//центрируем позицию новой платформы по X, сохран€ем высоту по Y
		nextPosition.x = 0f;

		//и затем прибавл€ем разброс позиции
